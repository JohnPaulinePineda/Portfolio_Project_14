...
|
| [C5.0 Decision Trees](https://link.springer.com/article/10.1007/BF00993309) generates multi-branch trees in a situation where one or more nominal inputs are given, using an information-based criterion (Entropy and Information Gain) as an attribute selection measure to build decision trees. For overfitting avoidance, the algorithm applies a pessimistic 
